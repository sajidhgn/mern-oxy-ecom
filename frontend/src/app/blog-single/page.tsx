...
const BlogSingle = () => {
      ...
      <header className="container rounded-xl">
        <div className="max-w-screen-md mx-auto space-y-5">
          ...
          <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            <div className="ox-PostMeta2 flex items-center flex-wrap text-neutral-700 text-left dark:text-neutral-200 text-sm leading-none flex-shrink-0">
              <Avatar
  ...
  const renderAuthor = () => {
    return (
      <div className="max-w-screen-md mx-auto ">
        <div className="ox-SingleAuthor flex">
  ...
  const renderCommentForm = () => {
    return (
      <div className="max-w-screen-md mx-auto pt-5">
        ...
        <form className="ox-SingleCommentForm mt-5">
          <Textarea />
  ...
  const renderCommentLists = () => {
    return (
      <div className="max-w-screen-md mx-auto">
        <ul className="ox-SingleCommentLists space-y-5">
          <li>
            <Comment />
  ...
  return (
    <div className="ox-PageSingle pt-8 lg:pt-16 ">
      {renderHeader()}
      <NcImage
        alt=""
        width={1260}
      ...
      <div className="ox-SingleContent container space-y-10">
        {renderContent()}
        {renderTags()}
