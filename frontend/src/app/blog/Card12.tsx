...
const Card12: FC<Card12Props> = ({ className = "h-full" }) => {
  return (
    <div className={`ox-Card12 group relative flex flex-col ${className}`}>
      <Link
        href={"/blog-single"}
      ...
      <div className=" mt-8 pr-10 flex flex-col">
        <h2
          className={`ox-card-title block font-semibold text-neutral-900 dark:text-neutral-100 transition-colors text-lg sm:text-2xl`}
        >
          <Link
            href={"/blog-single"}
