...
const Card3Small: FC<Card3SmallProps> = ({ className = "h-full" }) => {
  return (
    <div
      className={`ox-Card3Small relative flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center ${className}`}
      data-ox-id="Card3Small"
    >
      <Link
        href={"/blog-single"}
      ...
      <div className="relative space-y-2">
        <PostCardMeta />
        <h2 className="ox-card-title block text-base font-semibold text-neutral-900 dark:text-neutral-100">
          <Link
            href={"/blog-single"}
