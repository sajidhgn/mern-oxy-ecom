...
const Card3: FC<Card3Props> = ({ className = "h-full" }) => {
  return (
    <div
      className={`ox-Card3 relative flex flex-col-reverse sm:flex-row sm:items-center rounded-[40px] group ${className}`}
      data-ox-id="Card3"
    >
      <div className="flex flex-col flex-grow">
        <div className="space-y-5 mb-4">
          ...
          <div>
            <h2
              className={`ox-card-title block font-semibold text-neutral-900 dark:text-neutral-100 text-xl`}
            >
              <Link
                href={"/blog-single"}
