...
const BgGlassmorphism: FC<BgGlassmorphismProps> = ({
  ...
  return (
    <div
      className={`ox-BgGlassmorphism ${className}`}
      data-ox-id="BgGlassmorphism"
    >
      <span className="block bg-[#ef233c] w-72 h-72 rounded-full mix-blend-multiply filter blur-3xl opacity-10 lg:w-96 lg:h-96"></span>
      <span className="block bg-[#04868b] w-72 h-72 -ml-20 mt-40 rounded-full mix-blend-multiply filter blur-3xl opacity-10 lg:w-96 lg:h-96 ox-animation-delay-2000"></span>
    </div>
  );
};
