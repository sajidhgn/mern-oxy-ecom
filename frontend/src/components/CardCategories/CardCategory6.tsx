...
const CardCategory6: FC<CardCategory6Props> = ({
  ...
  return (
    <div
      className={`ox-CardCategory6 relative w-full aspect-w-1 aspect-h-1 h-0 rounded-3xl overflow-hidden bg-white dark:bg-neutral-900 group hover:ox-shadow-lg transition-shadow ${className}`}
    >
      <div>
