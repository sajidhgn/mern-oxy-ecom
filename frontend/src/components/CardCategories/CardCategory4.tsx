...
const CardCategory4: FC<CardCategory4Props> = ({
  ...
  return (
    <div
      className={`ox-CardCategory4 relative w-full aspect-w-12 aspect-h-11 h-0 rounded-3xl overflow-hidden bg-white dark:bg-neutral-900 group hover:ox-shadow-lg transition-shadow ${className}`}
    >
      <div>
